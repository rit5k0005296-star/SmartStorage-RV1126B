...
CLASSES = ("Bandage", "Glue stick", "Ruler", "Scissors", "Screwdriver", "Stapler", "Tape")
INTERESTED_CLASSES = ["Bandage", "Glue stick", "Ruler", "Scissors", "Screwdriver", "Stapler", "Tape"]
